...
class App:
    def __init__(self, root):
        ...
        self.combo_box = ttk.Combobox(root, values=LocationGraph().locations)
        self.combo_box.pack()
    ...
    def execute_weather_code(self):
        self.root.destroy()  # Close the current GUI window
        os.system("python weather2.py")  # Execute weather2.py
